...
def get_vaccines_hpi_poverty_data():
    ...
    results = session.query(vaccines_hpi_poverty_data.id,
    ...
    hpi_poverty_data = []
    for id, zip_code, percent_fully_vaccinated, percent_partially_vaccinated, employed_percentile, hpi_value in results:
